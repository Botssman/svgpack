/**
 * Turso-compatible seed: uses @libsql/client directly (no Prisma runtime).
 *
 * Usage:
...
async function main() {
  ...
  // 1. Upsert users (delete + create to keep IDs stable is risky; use INSERT OR IGNORE)
  ...
  console.log('  ✓ Old packs/icons cleaned')
